...
settings.DataStoreKey = "[REMOVED FOR SECURITY]"			 -- CHANGE THIS TO ANYTHING RANDOM! Key used to encrypt all datastore entries; Changing this will lose any saved data
...
settings.Banned = {"JakesBIox"}		-- List of people banned from the game 		  Format: {"Username"; "Username:UserId"; UserId; "Group:GroupId:GroupRank"; "Group:GroupId"; "Item:ItemID"; "GamePass:GamePassID";}
...
settings.HelpButtonImage = "rbxassetid://85072740325743" -- Sets the image used for the Adonis help button above.
